...
# Carregar dados de educação dos bairros
...
# Mapear faixas para categorias visuais
def mapear_categoria(faixa):
    if faixa == 'Quase perfeito (<2%)':
        ...
        return 'regular'
    else:  # Inclui "Abaixo da média" e "Crítico"
        return 'critico'
...
# Posições dos clusters de microrregiões (mesmo do projeto de saúde)
posicoes_clusters = {
...
# Criar arestas (removendo paralelas)
pares_vistos = {}
edges = []
...
# Calcular centros e raios das microrregiões
micro_info = {}
...
with open('grafico_educacao_recife/grafo_educacao.html', 'w', encoding='utf-8') as f:
    f.write(html_content)

print(f"\n✓ Visualização gerada: grafico_educacao_recife/grafo_educacao.html")
