...
# Construir grafo base (estrutura de bairros)
...
# Calcular posições dos bairros usando force-directed layout
posicoes = {}
...
with open('Visualizacao_Transporte/grafo_transporte.html', 'w', encoding='utf-8') as f:
    f.write(html_content)

print(f"\n✓ Visualização gerada: Visualizacao_Transporte/grafo_transporte.html")
