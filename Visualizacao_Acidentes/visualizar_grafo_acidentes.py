...
# Posições dos clusters - reduzidas para criar mapa de calor mais denso
posicoes_clusters = {
...
for micro, bairros_micro in microrregioes_agrupadas.items():
    ...
    if n_bairros == 1:
        ...
        # Reduzido para criar mapa de calor mais contínuo
...
# Criar nós com informações de acidentes
nodes = []
...
# Gerar HTML da visualização com mapa de calor
...
with open('Visualizacao_Acidentes/grafo_acidentes.html', 'w', encoding='utf-8') as f:
    f.write(html_content)

print(f"\n✓ Visualização gerada: Visualizacao_Acidentes/grafo_acidentes.html")
